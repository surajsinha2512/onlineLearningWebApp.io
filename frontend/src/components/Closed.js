...
const Closed=()=>{
    ...
    return (
        ...
        <div className=""><img src="https://d3njjcbhbojbot.cloudfront.net/api/utilities/v1/imageproxy/https://coursera_assets.s3.amazonaws.com/front-page-rebrand/value-props/certificate-crop.png?auto=format%2Ccompress&dpr=1&w=580&h=440&q=40" alt="..."/></div>
         <div className="">
